            ...
            <div class="col-md-12 m-b-sm">
                ...
                <div class="panel-hdr">
                    <div class="btn-group">
                        ...
                        <a href="{$app_url}storage/system/students.csv" class="btn btn-sm btn-primary"><i class="fal fa-download"></i> {$_L['Download Sample File']}</a>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default" id="uploading_inside">
                <div class="panel-body">
                    <form action="{$_url}students/app/csv_upload/" class="dropzone" id="upload_container">
    ...
    <script>
        ...
        $(function() {
            ...
            var ib_file = new Dropzone("#upload_container",
                {
                    url: _url + "students/app/csv_upload/",
                    maxFiles: 1,
                    acceptedFiles: ".csv"
                }
            );
            ...
            ib_file.on("success", function(file) {
                ...
                $.post(_url + 'students/app/csv_uploaded/', {
                    name: file.name
                })
                    .done(function (data) {
