...
{block name="content"}
    ...
    <div class="row">
        <div class="widget-1 col-md-6 col-sm-12">
            <div class="panel">
                <div class="panel-hdr">
                    <h2 class="panel-title">{$_L['Income Categories']}</h2>
                </div>
                <div class="panel-container">
                    <div class="panel-content">
                        <form role="form" name="accadd" method="post" action="{$_url}settings/income-categories-post">
        ...
        <div class="widget-1 col-md-6 col-sm-12">
            <div class="panel">
                <div class="panel-hdr">
                    <h2 class="panel-title">{$_L['Manage Categories']}</h2>
                </div>
                <div class="panel-container">
                    <div class="panel-content">
