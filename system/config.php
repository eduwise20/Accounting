...
define('DB_USER', 'finance'); # Database Username
define('DB_PASSWORD', 'F!n@nc3'); # Database Password
define('DB_NAME', 'finance'); # Database Name
define('APP_URL', 'https://finance.eduwisenepal.com.np'); # Application URL.
