            ...
            switch ($pg) {
                ...
                case 'manualpayment':
                    ...
                    if ($p) {
                        ...
                        $ui->assign(
                            'xheader',
                            Asset::css(['dropzone/dropzone', 'modal'])
                        );

                        $ui->assign(
                            'xfooter',
                            Asset::js(['modal', 'dropzone/dropzone'])
                        );
