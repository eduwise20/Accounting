...
class Update
{
  ...
  PRIMARY KEY (`id`)
        ...
        if (!db_column_exist('clx_projects', 'summary')) {
            ORM::execute(
                'ALTER TABLE `clx_projects` ADD `summary` VARCHAR(255) NULL DEFAULT NULL AFTER `name`, ADD `featured_image` VARCHAR(255) NULL DEFAULT NULL AFTER `summary`, ADD `members` TEXT NULL DEFAULT NULL AFTER `featured_image`'
            );
        }
  ...
  PRIMARY KEY (`id`)
        ...
        // From Date June 17, 2020. Version 5
 ...
 ADD `signature_data_svg` text');
        ...
        // ALTER TABLE `sys_users` ADD `mobile_phone` VARCHAR(100) NULL DEFAULT NULL AFTER `phonenumber`
