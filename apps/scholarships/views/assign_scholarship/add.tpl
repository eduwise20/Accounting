                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="radio">
                                                <label><input type="radio" name="assign_radio_button" value="multiple_students" checked> Assign a single scholarship to multiple students</label>
                                            </div>
                                            <div class="radio">
                                                <label><input type="radio" name="assign_radio_button" value="multiple_scholarships"> Assign multiple scholarships to a single student</label>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-container show" id="ibox_form">
                    ...
                    <div class="panel-content">
                        ...
                        <form id="assign_scholarship_to_student_form">
    ...
    <script>
        $(document).ready(function () {
            ...
            function getFacultyForClass(class_id) {
                $.post(base_url + 'scholarships/app_assign_scholarship/getFacultyForClass/',
                    { class_id : class_id },
            ...
            btn_assign.click(function (e) {
                ...
                $.post(base_url + 'scholarships/app_assign_scholarship/getStudentAndScholarship/',
                    postValue,
                    function (data, status){
                        if(data) {
            ...
            $("#btn_submit").click(function (e) {
                ...
                $.post(base_url + 'scholarships/app_assign_scholarship/save/', $('#assign_scholarship_to_student_master_form, #assign_scholarship_to_student_form').serialize())
                    .done(function (data) {
                        $('#ibox_form').unblock();
                        var body = $("html, body");
                        body.animate({ scrollTop:0 }, '1000', 'swing');
                        if ($.isNumeric(data)) {
                            $("#emsg").hide("slow");
                            $("#smsgbody").html("Scholarship assigned successfully");
                            $("#smsg").show("slow");
                        }
                        else {
                            $("#smsg").hide("slow");
        ...
        function changeStudentDropdown() {
            $.post(base_url + 'scholarships/app_assign_scholarship/getScholarshipsForStudent/',
                $('#assign_scholarship_to_student_master_form, #assign_scholarship_to_student_form').serialize(),
                function (data, status){
                    if(data) {
                        let returnedResult = JSON.parse(data);
        ...
        $(document).on('change', '#scholarship_dropdown', function () {
            $.post(base_url + 'scholarships/app_assign_scholarship/getStudentsForScholarship/',
                $('#assign_scholarship_to_student_master_form, #assign_scholarship_to_student_form').serialize(),
                function (data, status){
                    if(data) {
                        let returnedResult = JSON.parse(data);
