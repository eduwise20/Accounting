...
//            $d->weight = $weight;
            ...
            {
                $d->weight = createFromCurrency($data['weight'],$config['home_currency']);
            }
    ...
    case 'p-list':
        ...
        $ui->assign('xheader', Asset::css(array('modal','dropzone/dropzone','redactor/redactor')));
        $ui->assign('xfooter', Asset::js(array('clipboard.min','modal','dropzone/dropzone','redactor/redactor.min','numeric')));
    ...
    case 'edit-form':
        ...
        if($d){
            ...
            if($d->image != ''){
                $has_img = '<hr>
<img src="'.APP_URL.'/storage/items/'.$d->image.'" class="img-fluid">
';
            }
