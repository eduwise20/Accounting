            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <a href="{$_url}contacts/add/" class="btn btn-success"><i class="fal fa-plus"></i> {$_L['Add Customer']}</a>
                        <a href="{$_url}contacts/import_csv/" class="btn btn-primary"><i class="fal fa-upload"></i> {$_L['Import']}</a>
                        <a href="{$_url}contacts/export_csv/" class="btn btn-info"><i class="fal fa-download"></i> {$_L['Export']}</a>
                        ...
                        <table class="table table-bordered table-hover sys_table footable"  data-filter="#foo_filter" data-page-size="50">
                            ...
                            {foreach $d as $ds}
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{$_url}contacts/view/{$ds['id']}/" class="btn btn-primary btn-xs"><i class="fal fa-search"></i> </a>

                                        <a href="delete/crm-user/{$ds['id']}/" class="btn btn-danger btn-xs cdelete" id="uid{$ds['id']}"><i class="fal fa-trash"></i> </a>
                                    </td>
                                </tr>
                        ...
                        <form class="form-horizontal" method="post" action="{$_url}customers/list/">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="{$_url}contacts/add/" class="btn btn-success btn-block"><i class="fal fa-plus"></i> {$_L['Add New Contact']}</a>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <ul class="tag-list" style="padding: 0">
                            {foreach $t as $ts}
                                <li><a href="{$_url}contacts/list/{$ts['text']}/"><i class="fal fa-tag"></i> {$ts['text']}</a></li>
                            {/foreach}
                        </ul>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-hover sys_table">
                                ...
                                {foreach $d as $ds}
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a href="{$_url}contacts/view/{$ds['id']}/" class="btn btn-primary btn-xs"><i class="fal fa-search"></i> {$_L['View']}</a>

                                            <a href="delete/crm-user/{$ds['id']}/" class="btn btn-danger btn-xs cdelete" id="uid{$ds['id']}"><i class="fal fa-trash"></i> {$_L['Delete']}</a>
                                        </td>
                                    </tr>
