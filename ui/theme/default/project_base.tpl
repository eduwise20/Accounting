...
{block name="content"}
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect fill="#000000" opacity="0.3" x="2" y="4" width="5" height="16" rx="1"/>
                            ...
                            <a class="nav-link {if $action == 'financials'}active{/if}"  href="{$_url}projects/financials/{$project->id}">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"/>
                                ...
                                <span class="hidden-sm-down ml-1"> Financials</span>
                            </a>
                            <a class="nav-link {if $action == 'gantt-chart'}active{/if}"  href="{$_url}projects/gantt-chart/{$project->id} role="tab">
{*                                <i class="fal fa-cog"></i>*}
                            ...
                            <a class="nav-link {if $action == 'timelog'}active{/if}"  href="{$_url}projects/timelog/{$project->id} role="tab">
{*                            <i class="fal fa-cog"></i>*}
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
