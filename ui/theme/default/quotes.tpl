                    ...
                    <table class="table table-striped w-100" id="clx_datatable">
                        ...
                        {foreach $d as $ds}
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="btn-group">
                                        <a href="{$_url}quotes/view/{$ds['id']}/" class="btn btn-primary btn-icon waves-effect waves-themed has-tooltip" data-title="{$_L['View']}" data-placement="top"><i class="fal fa-user-alt"></i> </a>
