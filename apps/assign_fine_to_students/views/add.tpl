                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="radio">
                                                <label><input type="radio" name="assign_radio_button" value="multiple_students" checked> Multiple students one fine</label>
                                            </div>
                                            <div class="radio">
                                                <label><input type="radio" name="assign_radio_button" value="multiple_fines"> Multiple fines one student</label>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function getFacultyForClass(class_id) {
                $.post(base_url + 'assign_fine_to_students/app/getFacultyForClass/',
                    { class_id : class_id },
            ...
            function getSubCategoriesForCategory(category_id) {
                $.post(base_url + 'assign_fine_to_students/app/getSubCategoriesForCategory/',
            ...
            btn_assign.click(function (e) {
                ...
                $.post(base_url + 'assign_fine_to_students/app/getStudentAndFine/',
                    postValue,
                    function (data, status){
                        if(data) {
            ...
            $("#btn_submit").click(function (e) {
                ...
                $.post(base_url + 'assign_fine_to_students/app/save/', $('#assign_fine_to_student_master_form, #assign_fine_to_student_form').serialize())
                    .done(function (data) {
                        if ($.isNumeric(data)) {
                            window.location = base_url + 'assign_fine_to_students/app/add';
                        }
                        else {
                            $('#ibox_form').unblock();
                            var body = $("html, body");
        ...
        function changeStudentDropdown() {
            $.post(base_url + 'assign_fine_to_students/app/getFinesForStudent/',
        ...
        $(document).on('change', '#fine_dropdown', function () {
            $.post(base_url + 'assign_fine_to_students/app/getStudentsForFine/',
