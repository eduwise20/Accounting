            ...
            <div class="panel">
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        ...
                        <div id="result">
                            <h2>{$_L['Total Income']}: {$config['currency_code']} {number_format($cr,2,$config['dec_point'],$config['thousands_sep'])}</h2>
                            <h2>{$_L['Total Expense']}: {$config['currency_code']} {number_format($dr,2,$config['dec_point'],$config['thousands_sep'])}</h2>
