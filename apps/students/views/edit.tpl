                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="name" name="name" class="form-control" value="{$student->name}" autofocus>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="admission_no" name="admission_no" class="form-control" value="{$student->admission_no}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="roll_no" name="roll_no" class="form-control" value="{$student->roll_no}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="section_id" class="col-sm-3"><span class="h6">Section</span><span class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            ...
                                            <select id="sub_category_id" name="sub_category_id" class="custom-select">
                                                ...
                                                {foreach $sub_categories as $sub_category}
                                                    <option value="{$sub_category->id}"
                                                            {if $student->sub_category_id === $sub_category->id}
                                                    selected {/if}>
                                                        {$sub_category->name}
                                                    </option>
                                                {/foreach}
                                            ...
                                            <select id="student_type_id" name="student_type_id" class="custom-select">
                                                ...
                                                {foreach $student_types as $student_type}
                                                    <option value="{$student_type->id}"
                                                            {if $student->student_type_id === $student_type->id}
                                                    selected {/if}>
                                                        {$student_type->name}
                                                    </option>
                                                {/foreach}
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="phone" name="phone" class="form-control" value="{$student_additional_information->phone}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="current_address" name="current_address" class="form-control" value="{$student_additional_information->current_address}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="permanent_address" name="permanent_address" class="form-control" value="{$student_additional_information->permanent_address}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="parent_name" name="parent_name" class="form-control" value="{$student_additional_information->parent_name}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="local_guardian_name" name="local_guardian_name" class="form-control" value="{$student_additional_information->local_guardian_name}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="radio">
                                                <label><input type="radio" name="gender" value="Male" {if $student_additional_information->gender eq "Male"}checked{/if}> Male</label>
                                            </div>
                                            <div class="radio">
                                                <label><input type="radio" name="gender" value="Female" {if $student_additional_information->gender eq "Female"}checked{/if}> Female</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="remarks" name="remarks" class="form-control" value="{$student->remarks}">
                                        </div>
                                    </div>

                                    <input type="hidden" name="id" value="{$student->id}" />
                                    <input type="hidden" name="student_additional_information_id" value="{$student_additional_information->id}" />
...
{block name="script"}
    <script>
        $(document).ready(function () {
            ...
            if({isset($student->faculty_id)} && {$student->faculty_id} == 0) {
                faculty_section.hide();
            }

            if({isset($student->sub_category_id)} && {$student->sub_category_id} == 0) {
