...
switch ($action) {
    ...
    case 'edit':
        ...
        if($action === 'edit')
        {
            ...
            $purchase_items =  PurchaseItem::where('invoiceid',$purchase->id)->orderBy('id','asc')->get();
...
//            }
            ...
            if(_post('purchase_id'))
            {
                ...
                if($purchase)
                {
                    PurchaseItem::where('invoiceid',$purchase->id)
                        ->delete();
                }
...
' . $cats_opt . '
  ...
  <div class="form-group">
    <label for="payer_name">' . $_L['Payee'] . '</label>
