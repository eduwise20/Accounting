    ...
    case 'json_invoices':
        ...
        foreach($x as $xs) {
            ...
            $records["data"][] = array(
                ...
                $due,
                $xs['date'],
                '<a href="' . U . 'invoices/view/' . $xs['id'] . '" class="btn btn-primary btn-xs"><i class="fal fa-file-alt"></i></a>',
            );
        }
    ...
    case 'json_purchases':
        ...
        foreach($x as $xs) {
            ...
            $records["data"][] = array(
                ...
                $due,
                $xs['date'],
                '<a href="' . U . 'purchases/view/' . $xs['id'] . '" class="btn btn-primary btn-xs"><i class="fal fa-file-alt"></i></a>',
            );
        }
