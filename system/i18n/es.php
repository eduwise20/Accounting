...
$_L = [
    ...
    'notice_email_as_username' => 'Por favor, use una dirección de correo electrónico válida como nombre de usuario',
    'API' => 'API',
    ...
    'cron_invoice_created' => 'Trabajo de CRON: enviar automáticamente facturas de correo electrónico creado',
    ...
    'Send Client Signup Email' => 'Establezca Sí para enviar el correo electrónico de suscripción del cliente.',
    'Profile' => 'Perfil',
    'Download' => 'Descargar',
    'Legacy' => 'Legado',
    'New' => 'Nuevo',
    ...
    'Recaptcha' => 'reCAPTCHA',
    'Recaptcha Verification Failed' => 'Por favor verifica que no eres un robot.',
    ...
    'An error occurred while sending email' => 'Se produjo un error al enviar un correo electrónico.',
    'Catalog' => 'Catalogar',
    ...
    'Code' => 'Código',
    'Create tasks automatically from ticket' => 'Crea tareas automáticamente desde el ticket',
    'Expertise' => 'Pericia',
    ...
    'Width' => 'Anchura',
    'Height' => 'Altura',
    'Enable Recaptcha in Client Login' => 'Habilite Recaptcha en el inicio de sesión del cliente',
    'Enable Recaptcha in Admin Login' => 'Habilite Recaptcha en el inicio de sesión de administrador',
    'Customer list show company' => 'Lista de clientes mostrar empresa',
    'Customer list show group' => 'Lista de clientes mostrar grupo',
    'Send sms notification to admin when ticket is assigned' => 'Enviar notificación de SMS al administrador cuando se asigna el ticket',
    'Admin - Disable customer welcome email' => 'Administrador: deshabilite el correo electrónico de bienvenida del cliente',
    'Option to enabled Add Fund to Client' => 'Opción para habilitar Agregar fondo al cliente',
    'Minimum Deposit' => 'Depósito mínimo',
    'Enter the minimum amount a client can add in a single transaction' => 'Ingrese la cantidad mínima que un cliente puede agregar en una sola transacción',
    'Maximum Deposit' => 'Depósito Máximo',
    'Enter the maximum amount a client can add in a single transaction' => 'Ingrese la cantidad máxima que un cliente puede agregar en una sola transacción',
    'Enable Add Fund Option from Client Portal' => 'Habilite la opción Agregar fondo desde el portal del cliente',
    'Adding of funds by clients from the client dashboard' => 'Adición de fondos por parte de los clientes desde el panel del cliente',
    'Order Method' => 'Método de pedido',
    'Place Order, Create Invoice Later' => 'Realizar pedido, crear factura más tarde',
