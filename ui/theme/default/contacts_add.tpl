...
{*                                    <div class="form-group"><label class="form-label" for="cpassword">{$_L['Confirm Password']}</label>*}
...
{*                                            <div class="custom-control custom-switch">*}
{*                                                <input type="checkbox" name="send_client_signup_email" class="custom-control-input" id="send_client_signup_email">*}
{*                                                <label class="custom-control-label" for="send_client_signup_email">{$_L['Welcome Email']}</label>*}
{*                                            </div>*}
