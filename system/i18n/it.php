...
$_L = [
    ...
    'An error occurred while sending email' => 'Si è verificato un errore durante l\'invio di e-mail',
    'Catalog' => 'Catalogare',
    ...
    'Code' => 'Codice',
    'Create tasks automatically from ticket' => 'Crea attività automaticamente dal ticket',
    ...
    'Enable Recaptcha in Admin Login' => 'Abilita Recaptcha in Accesso amministratore',
    'Customer list show company' => 'Elenco clienti mostra azienda',
    'Customer list show group' => 'Elenco clienti mostra gruppo',
    'Send sms notification to admin when ticket is assigned' => 'Invia notifica sms all\'amministratore quando viene assegnato il ticket',
    'Admin - Disable customer welcome email' => 'Amministratore: disabilita l\'e-mail di benvenuto del cliente',
    'Option to enabled Add Fund to Client' => 'Opzione per abilitare Aggiungi fondo al cliente',
    'Minimum Deposit' => 'Deposito minimo',
    'Enter the minimum amount a client can add in a single transaction' => 'Inserisci l\'importo minimo che un cliente può aggiungere in una singola transazione',
    'Maximum Deposit' => 'Deposito massimo',
    'Enter the maximum amount a client can add in a single transaction' => 'Inserisci l\'importo massimo che un cliente può aggiungere in una singola transazione',
    'Enable Add Fund Option from Client Portal' => 'Abilita l\'opzione Aggiungi fondo dal portale clienti',
    'Adding of funds by clients from the client dashboard' => 'Aggiunta di fondi da parte dei clienti dalla dashboard del cliente',
    'Order Method' => 'Metodo di ordine',
    'Place Order, Create Invoice Later' => 'Effettua ordine, crea fattura più tardi',
    'Show Business Number' => 'Mostra il numero dell\'attività',
    'Business Number Label Name' => 'Numero etichetta Nome attività commerciale',
    'Initial balance' => 'Equilibrio iniziale',
    ...
    'Tickets:Admin Ticket Created' => 'Biglietti: biglietto amministratore creato',
