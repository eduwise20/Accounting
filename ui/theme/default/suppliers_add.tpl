                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group"><label class="col-md-4 control-label" for="cid">{$_L['Company']}</label>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <span class="help-block"><a href="#" class="add_company"><i class="fal fa-plus"></i> {$_L['New Company']}</a> </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-lg-10">
                                        ...
                                        <button class="md-btn md-btn-primary waves-effect waves-light" type="submit" id="submit"><i class="fal fa-check"></i> {$_L['Save']}</button> | <a href="{$_url}contacts/list/">{$_L['Or Cancel']}</a>
