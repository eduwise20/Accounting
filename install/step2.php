                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tr>
                        <td>
                            <h3>PHP 7.2.5</h3>
                            <p>
                                We use the latest coding syntax of PHP, which requires a minimum version of PHP 7.2.5. Of course, you can use any higher version.
                            </p>
                        </td>
                        <td>
        ...
        <path d="M16.7689447,7.81768175 C17.1457787,7.41393107 17.7785676,7.39211077 18.1823183,7.76894473 C18.5860689,8.1457787 18.6078892,8.77856757 18.2310553,9.18231825 L11.2310553,16.6823183 C10.8654446,17.0740439 10.2560456,17.107974 9.84920863,16.7592566 L6.34920863,13.7592566 C5.92988278,13.3998345 5.88132125,12.7685345 6.2407434,12.3492086 C6.60016555,11.9298828 7.23146553,11.8813212 7.65079137,12.2407434 L10.4229928,14.616916 L16.7689447,7.81768175 Z" fill="#000000" fill-rule="nonzero"/>
                        ...
                        <td>
                            ...
                            if (version_compare(PHP_VERSION, '7.1.3') >= 0) {
                                echo '<i class="fal fa-check"></i> Awesome! your PHP version is '.PHP_VERSION;
                            } else {
        ...
        <path d="M16.7689447,7.81768175 C17.1457787,7.41393107 17.7785676,7.39211077 18.1823183,7.76894473 C18.5860689,8.1457787 18.6078892,8.77856757 18.2310553,9.18231825 L11.2310553,16.6823183 C10.8654446,17.0740439 10.2560456,17.107974 9.84920863,16.7592566 L6.34920863,13.7592566 C5.92988278,13.3998345 5.88132125,12.7685345 6.2407434,12.3492086 C6.60016555,11.9298828 7.23146553,11.8813212 7.65079137,12.2407434 L10.4229928,14.616916 L16.7689447,7.81768175 Z" fill="#000000" fill-rule="nonzero"/>
                        ...
                        <td>
                            ...
                            <?php
                                ...
                                <i class="fal fa-times-circle"></i> Oops! How come! it's not installed in <?php echo date('Y'); ?>! If you manage your server, enable it. Or ask your hosting provider to enable it.
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M16.7689447,7.81768175 C17.1457787,7.41393107 17.7785676,7.39211077 18.1823183,7.76894473 C18.5860689,8.1457787 18.6078892,8.77856757 18.2310553,9.18231825 L11.2310553,16.6823183 C10.8654446,17.0740439 10.2560456,17.107974 9.84920863,16.7592566 L6.34920863,13.7592566 C5.92988278,13.3998345 5.88132125,12.7685345 6.2407434,12.3492086 C6.60016555,11.9298828 7.23146553,11.8813212 7.65079137,12.2407434 L10.4229928,14.616916 L16.7689447,7.81768175 Z" fill="#000000" fill-rule="nonzero"/>
                ...
                if(!$all_passed)
                {
                    ...
                    echo '<a href="step3.php" class="btn btn-primary">Continue</a>';
                }
                ?>
            </div>
        </div>
