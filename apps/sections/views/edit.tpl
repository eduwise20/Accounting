                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="name" name="name" class="form-control" autofocus value="{$section->name}">
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#submit").click(function (e) {
                ...
                $.post(base_url + 'sections/app/save/', $( "#rform" ).serialize())
                    .done(function (data) {
                        var sbutton = $("#submit");
                        if ($.isNumeric(data)) {
                            window.location = base_url + 'sections/app/list';
                        }
                        else {
                            $('#ibox_form').unblock();
                            var body = $("html, body");
