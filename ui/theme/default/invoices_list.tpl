...
{*                        <div class="text-nowrap text-white font-weight-600"> {$_L['Percentage']} </div>*}
                                        ...
                                        <td class="text-right">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                {if $ds['r'] neq '0'}
                                                    ...
                                                    <a href="{$_url}invoices/stop_recurring/{$ds['id']}/" class="btn btn-info btn-icon" data-toggle="tooltip" data-placement="top" title="{$_L['Stop Recurring']}"><i class="fal fa-stop-circle-o"></i></a>
