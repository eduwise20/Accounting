                            ...
                            <div class="bill-data text-right">
                                ...
                                {if (($d['status']) neq 'Paid') AND (ib_pg_count() neq '0' AND (($d['status']) neq 'Cancelled'))}
                                    ...
                                    {if $render === 'delivery'}
                                        ...
                                        <form class="form-inline float-right mt-5 mb-4" method="post" action="{$_url}client/ipay/{$d['id']}/token_{$d['vtoken']}">
                                            ...
                                            {/if}
                                            <button type="submit" id="btnPayNow" class="btn btn-primary ml-sm "><i class="fal fa-credit-card"></i> {$_L['Pay Now']}</button>
