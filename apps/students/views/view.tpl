...
{block name="content"}
    <div class="row">
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-hdr">
                    <h2><span></span>Student Information</h2>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student->name}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student->admission_no}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student->roll_no}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student->class}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student->section}</span></p>
                                    </div>
                                </div>
                                {/if}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student->category}</span></p>
                                    </div>
                                </div>
                                {/if}
                                ...
                                <div class="form-group row" id="sub_category_section">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student->sub_category}</span></p>
                                    </div>
                                </div>
                                {/if}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student->student_type}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" id="faculty_section">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student->faculty}</span></p>
                                    </div>
                                </div>
                                {/if}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$status[$student->status]}</span></p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student_additional_information->phone}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student_additional_information->current_address}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student_additional_information->permanent_address}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student_additional_information->parent_name}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student_additional_information->local_guardian_name}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student_additional_information->gender}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <p><span class="onoffswitch-title">{$student->remarks}</span></p>
                                    </div>
                                </div>
