...
<form class="form-horizontal" id="rform">
    ...
    <div class="form-group"><label for="account">{$_L['Account Name']}</label>

        <input type="text" id="account" name="account" class="form-control" value="{$d['account']}">
    </div>


    <div class="form-group"><label for="code">{$_L['Code']}</label>
    ...
    <div class="form-group"><label for="company_id">{$_L['Company']}</label>
    ...
    <div class="form-group"><label for="edit_email">{$_L['Email']}</label>

        <input type="text" id="edit_email" name="edit_email" class="form-control" value="{$d['email']}">
    </div>


    <div class="form-group"><label for="edit_secondary_email">{$_L['Secondary Email']}</label>
    ...
    {if $config['fax_field']}
        ...
        <div class="form-group"><label for="phone">{$_L['Fax']}</label>
    ...
    <div class="form-group"><label for="address">{$_L['Address']}</label>
    ...
    <div class="form-group"><label for="group">{$_L['Group']} </label>
    ...
    {if $config['customer_custom_username']}
        ...
        <div class="form-group"><label for="username">{$_L['Username']} </label>
        ...
        <div class="form-group"><label for="password">{$_L['Password']} </label>
    ...
    <div class="form-group"><label for="cid">{$_L['Type']}</label>
    ...
    <div class="form-group"><label for="tags">{$_L['Tags']}</label>
