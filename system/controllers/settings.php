...
'
    ...
    case 'users-edit':
        ...
        if ($d) {
            ...
            $ui->assign('xfooter', Asset::js(['imgcrop/croppic']));
    ...
    case 'app-post':
        ...
        if (APP_STAGE == 'Demo') {
            ...
            $d = ORM::for_table('sys_appconfig')
                ->where('setting', 'show_quantity_as')
                ->find_one();
            ...
            if (file_exists($pl_path . '/manifest.php')) {
                ...
                if ($d) {
                    ...
                    $btn .=
                        ...
                        $pl .
                        '/" class="btn btn-primary btn-sm cedit"> Install </a>';
                    $btn .=
                        ' <a href="' .
                        U .
                        'settings/plugin_delete/' .
                        $pl .
                        '/" class="btn btn-danger btn-sm cdelete"> Delete </a>';
                }
 ...
 '
    ...
    case 'add_currency_post':
        ...
        if ($f_type == 'edit') {
            ...
            $check = M::factory('Models_Currency')
                ->where('cname', $cname)
                ->find_one();
...
_L[\'are_you_sure\'] = \'' .
 ...
 '
        ...
        $ui->assign('xheader', Asset::css(['modal']));
        $ui->assign('xfooter', Asset::js(['modal', 'js/units']));
        view('settings_units');
