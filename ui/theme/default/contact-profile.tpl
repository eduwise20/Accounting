                ...
                <div class="panel-body">
                    ...
                    <table class="table table-hover margin bottom">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><button class="btn btn-outline btn-primary btn-xs" type="button"><i class="fal fa-plus"></i></button></td>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><button class="btn btn-outline btn-danger btn-xs" type="button"><i class="fal fa-minus"></i></button></td>
                    ...
                    <a class="btn btn-danger cdelete" href="#" id="{$d['id']}"><i class="fal fa-paste"></i> Delete This Contact</a>
        ...
        <div class="col-lg-12">
            ...
            <div class="tabs">
                <ul class="nav nav-tabs tabs-primary">
                    <li class="active">
                        <a href="#overview" data-toggle="tab"><i class="fal fa-send-o"></i> Activity</a>
                    </li>
                    {*<li class="">*}
                    {*<a href="#todo" data-toggle="tab"><i class="fal fa-tasks"></i> Tasks</a>*}
                    {*</li>*}
                    <li class="">
                                ...
                                <section class="activity-post mb-xlg">
                                    ...
                                    <div class="compose-box-footer">
                                        <ul class="compose-toolbar">
                                            <li class="clickable"><a href="#"><i class="fal fa-envelope-o"></i></a></li>
                                            <li class="clickable"><a href="#"><i class="fal fa-phone"></i></a></li>
                                            <li class="clickable"><a href="#"><i class="fal fa-send-o"></i></a></li>
                                            <li class="clickable"><a href="#"><i class="fal fa-file-pdf-o"></i></a></li>
