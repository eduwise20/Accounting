        ...
        <nav id="js-primary-nav" class="primary-nav" role="navigation">
            ...
            <ul id="js-nav-menu" class="nav-menu">
                ...
                {if has_access($user->roleid,'reports')}
                    <li {if $_application_menu eq 'dashboard'}class="active"{/if}><a href="{$_url}{$config['redirect_url']}">
                ...
                {if has_access($user->roleid,'customers')}
                    ...
                    <li class="{if $_application_menu eq 'contacts'}active  open{/if}">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                {if has_access($user->roleid,'transactions')}
                    {if $config['accounting'] eq '1'}
                        ...
                        <li class="{if $_application_menu eq 'transactions'}active  open{/if}">
                            <a href="#">
                ...
                {if has_access($user->roleid,'sales')}
                    ...
                    {if ($config['invoicing'] eq '1') OR ($config['quotes'] eq '1')}
                        ...
                        <li class="{if $_application_menu eq 'invoices'}active open{/if}">
                            <a href="#">
                ...
                {if has_access($user->roleid,'suppliers') && ($config['suppliers'])}
                    ...
                    <li class="{if $_application_menu eq 'suppliers'}active open{/if}">
                        <a href="#">
                ...
                {if has_access($user->roleid,'purchase') && ($config['purchase'])}
                    ...
                    <li class="{if $_application_menu eq 'purchase'}active open{/if}">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                {if has_access($user->roleid,'projects') && ($config['projects'])}
                    <li {if $_application_menu eq 'projects'}class="active"{/if}><a href="{$_url}projects">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                {if has_access($user->roleid,'leads','view') && ($config['leads'])}
                    ...
                    <li class="{if $_application_menu eq 'leads'}active open{/if}">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                {if has_access($user->roleid,'sms') && ($config['sms'])}
                    ...
                    <li class="{if $_application_menu eq 'sms'}active open{/if}">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                {if has_access($user->roleid,'support') && ($config['support'])}
                    ...
                    <li class="{if $_application_menu eq 'support'}active open{/if}">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                {if has_access($user->roleid,'kb') && ($config['kb'])}
                    ...
                    <li class="{if $_application_menu eq 'kb'}active open{/if}">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"></rect>
                ...
                {if has_access($user->roleid,'orders') && ($config['orders'])}
                    ...
                    {if ($config['orders'] eq '1')}
                        ...
                        <li class="{if $_application_menu eq 'orders'}active open{/if}">
                            <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"/>
                ...
                {if has_access($user->roleid,'hrm') && ($config['hrm'])}
                    ...
                    {if ($config['hrm'] eq '1')}
                        ...
                        <li class="{if $_application_menu eq 'hrm'}active open{/if}">
                            <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <polygon points="0 0 24 0 24 24 0 24"/>
                ...
                {if has_access($user->roleid,'documents') && ($config['documents'])}
                    <li {if $_application_menu eq 'documents'}class="active open"{/if}>
                ...
                {if has_access($user->roleid,'tasks') && ($config['tasks'])}
                    <li {if $_application_menu eq 'tasks'}class="active open"{/if}><a href="{$_url}tasks">
                ...
                {if has_access($user->roleid,'calendar') && ($config['calendar'])}
                    <li {if $_application_menu eq 'calendar'}class="active open"{/if}><a href="{$_url}calendar/events">
                ...
                {if has_access($user->roleid,'products_n_services')}
                    ...
                    {if ($config['invoicing'] eq '1') OR ($config['quotes'] eq '1')}
                        <li class="{if $_application_menu eq 'ps'}active open{/if}">
                            <a href="#">
                            ...
                            <ul>
                                ...
                                {/if}
                                <li><a href="{$_url}ps/p-list"><span class="nav-link-text">{$_L['Products']}</span> </a></li>
                                <li><a href="{$_url}ps/p-new"><span class="nav-link-text">{$_L['New Product']}</span></a></li>
                                <li><a href="{$_url}ps/s-list"><span class="nav-link-text">{$_L['Services']}</span></a></li>
                ...
                {if has_access($user->roleid,'reports')}
                    ...
                    <li class="{if $_application_menu eq 'reports'}active open{/if}">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                {if has_access($user->roleid,'utilities')}
                    ...
                    <li class="{if $_application_menu eq 'util'}active open{/if}">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                {if has_access($user->roleid,'appearance')}
                    ...
                    <li class="{if $_application_menu eq 'appearance'}active open{/if}" id="li_appearance">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                {if has_access($user->roleid,'plugins') && ($config['plugins'])}
                    <li {if $_application_menu eq 'plugins'}class="active open"{/if}><a href="{$_url}settings/plugins/">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                {if has_access($user->roleid,'settings')}
                    <li class="{if $_application_menu eq 'settings'}active open{/if}" id="li_settings">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
