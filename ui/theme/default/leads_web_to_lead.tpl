                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group float-right">
                                    ...
                                    <a class="btn btn-danger btn-icon waves-effect waves-themed has-tooltip" data-toggle="tooltip" data-title="{$_L['Delete']}" data-placement="top" href="#"><i class="fal fa-trash-alt"></i></a>
                                </div>
                            </td>
