...
function add_menu_admin($name,$link='#',$c='',$icon='icon-leaf',$position=5,$submenu=array()){
    ...
    if(!empty($submenu)){
        ...
        $admin_extra_nav[$position] .= '<li class="'.$active.'"> <a href="javascript:void(0);" class="waves-effect waves-themed"><i class="'.$icon.'"></i> <span class="hide-menu"> '.$name.' <span class="fa arrow"></span></span></a>
...
function add_menu_admin_svg($name,$link='#',$c='',$icon='icon-leaf',$position=5,$submenu=array()){
    ...
    if(!empty($submenu)){
        ...
        $admin_extra_nav[$position] .= '<li class="'.$active.'"> <a href="javascript:void(0);" class="waves-effect waves-themed">'.$icon.' <span class="hide-menu"> '.$name.' <span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                '.$s.'
                            </ul>
                        </li>';
