                ...
                {if $type eq 'admin_auth'}
                    ...
                    <div class="mx-auto" style="max-width: 440px;">
                        <div class="card p-4">
                            ...
                            <form method="post" class="mt-3" action="{$_url}login/post/{if isset($after)}{$after}/{/if}">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-block btn-lg">{$_L['Sign in']}</button>
                                </div>
                            </form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 ml-auto">
                            <div class="card p-4" style="box-shadow: 1px 0 20px rgba(0, 0, 0, .08);">
                                ...
                                <form method="post" class="mt-3" action="{$_url}client/auth/">
                                    <div class="form-group">
                                        <label class="form-label" for="username">{$_L['Email Address']}</label>
                                        <input id="username" name="username" class="form-control form-control-lg" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary btn-block btn-lg">{$_L['Login']}</button>
                                    </div>
                ...
                {elseif $type eq 'client_register'}
                    ...
                    <div class="mx-auto" style="max-width: 440px;">
                        <div class="card p-4">
                            ...
                            <form method="post" class="mt-3" action="{$_url}client/register_post/">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-block btn-lg">{$_L['Register']}</button>
                                </div>
                            </form>
